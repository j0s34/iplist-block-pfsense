...
# download linkedinparsed

download('https://raw.githubusercontent.com/j0s34/BlockDomain/main/linkedin', 'linkedinparsed')
...
# open the linkedinparsed file
with open('linkedinparsed', mode = 'r', encoding = 'utf-8') as f:
